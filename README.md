...
The [JSON file](https://github.com/ABSanthosh/Gastly/blob/master/src/Assets/FromOldJson.json) with all the pokemon details is generated by [this program](https://github.com/ABSanthosh/Pokemon-Sprite-Scraper).
